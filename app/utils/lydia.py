...
def get_payment_url(pceen: PCeen, offer: Offer, phone: str | None) -> str:
    """Get URL to send the pceen to to make him pay.
    ...
    try:
        ...
        return create_payment(pceen, offer, phone)
    else:
...
def create_payment(pceen: PCeen, offer: Offer, phone: str | None) -> str:
    ...
    rep = requests.post(
        ...
        data={
            ...
            "currency": "EUR",
            "recipient": (phone or pceen.email or f"{pceen.username}@no-email.org"),
