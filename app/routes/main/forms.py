...
BOOTSTRAP_ICONS = [
    ("", _l("— Aucune icône —")),
    ("megaphone-fill", _l("Mégaphone")),
    ("info-circle-fill", _l("Information")),
    ("exclamation-triangle-fill", _l("Avertissement")),
    ("exclamation-octagon-fill", _l("Alerte")),
    ("calendar-event-fill", _l("Événement")),
    ("music-note-beamed", _l("Musique")),
    ("cup-fill", _l("Bar")),
    ("receipt-cutoff", _l("Ticket")),
    ("star-fill", _l("Étoile")),
    ("gift-fill", _l("Cadeau")),
    ("people-fill", _l("Personnes")),
    ("award-fill", _l("Médaille")),
    ("house-fill", _l("Maison")),
    ("trophy-fill", _l("Trophée")),
    ("camera-fill", _l("Appareil photo")),
    ("pin-map-fill", _l("Carte")),
    ("heart-fill", _l("Cœur")),
    ("lightning-charge-fill", _l("Éclair")),
    ("bell-fill", _l("Cloche")),
    ("check-circle-fill", _l("Validé")),
    ("x-circle-fill", _l("Annulé")),
    ("lock-fill", _l("Verrou")),
    ("envelope-fill", _l("Email")),
    ("chat-fill", _l("Chat")),
    ("wrench", _l("Outils")),
    ("broadcast", _l("Diffusion")),
    ("file-earmark-text-fill", _l("Document")),
    ("bookmark-fill", _l("Signet")),
    ("tag-fill", _l("Étiquette")),
    ("patch-question-fill", _l("Question")),
]
