"""PC est magique Flask App - Emails System"""
...
from app import PCEstMagiqueApp, mail, typing
...
def _send_email(app: PCEstMagiqueApp, template: str, msg: flask_mail.Message) -> None:
...
def send_email(
    ...
    *,
    ...
    sender_mail = flask.current_app.config[sender][0]

    msg = flask_mail.Message(
        subject=subject,
        sender=f"PC est magique <{sender_mail}>",
