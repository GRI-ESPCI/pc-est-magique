...
def upgrade():
    ...
    op.alter_column("spectacle", "image_name", existing_type=sa.VARCHAR(length=120), nullable=True)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("spectacle", "image_name", existing_type=sa.VARCHAR(length=120), nullable=False)
